...
\begin{verbatim}
    '...if we truly accepted the full implications of language 
    theories which claim to go beyond the merely linguistic 
    and to take into account the ideological, historical, and 
    cultural basis of meaning, we would have to recognise 
    the translator’s inescapable authorial interference in 
    the process of translation and would have to review 
    most of the clichés which consider it as a ``serving'' 
    profession....'
